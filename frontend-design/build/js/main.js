...
/***/ "./src/js/components/heroScroll.js":
/*!*****************************************!*\
  !*** ./src/js/components/heroScroll.js ***!
  \*****************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   heroScroll: function() { return /* binding */ heroScroll; }\n/* harmony export */ });\nconst heroScroll = (() => {\n  const init = () => {\n    const hero = document.querySelector(\".hero\");\n    if (!hero) {\n      return;\n    }\n    const handleScroll = () => {\n      if (window.scrollY > 0) {\n        hero.classList.add(\"narrowed\");\n      } else {\n        hero.classList.remove(\"narrowed\");\n      }\n    };\n    window.addEventListener(\"scroll\", handleScroll);\n    handleScroll();\n  };\n  return {\n    init\n  };\n})();\n\n//# sourceURL=webpack://ninelines-template/./src/js/components/heroScroll.js?");
